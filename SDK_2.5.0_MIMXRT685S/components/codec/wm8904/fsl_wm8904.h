...
/*! @name Driver version */
/*@{*/
/*! @brief WM8904 driver version 2.0.3. */
#define FSL_WM8904_DRIVER_VERSION (MAKE_VERSION(2, 0, 3))
/*@}*/
 ...
 * @return kStatus_WM8904_Success if successful, different code otherwise.
 */
status_t WM8904_SelectLRCPolarity(codec_handle_t *handle, uint32_t polarity);
 ...
 * @return kStatus_WM8904_Success if successful, different code otherwise.
 */
status_t WM8904_EnableDACTDMMode(codec_handle_t *handle, wm8904_timeslot_t timeSlot);
 ...
 * @return kStatus_WM8904_Success if successful, different code otherwise.
 */
status_t WM8904_EnableADCTDMMode(codec_handle_t *handle, wm8904_timeslot_t timeSlot);
