...
- pin_list:
  ...
  - {pin_num: G15, peripheral: GPIO, signal: 'PIO1, 1', pin_signal: PIO1_1/FC4_SSEL2/SCT0_PIN_INP2/SCT0_OUT8/CTIMER1_MAT0, direction: INPUT, pupdena: disabled, pupdsel: pullDown,
    ibena: enabled, slew_rate: normal, drive: normal, amena: disabled, odena: disabled, iiena: disabled}
  - {pin_num: F16, peripheral: FLEXCOMM15, signal: SCL, pin_signal: FC15_SDA}
  - {pin_num: E16, peripheral: FLEXCOMM15, signal: SDA, pin_signal: FC15_SCL}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    /* PMIC I2C PIN */
    IOPCTL->FC15_I2C_SCL = IOPCTL_INBUF_EN | IOPCTL_PIO_PUPD_EN |
            IOPCTL_PIO_PULLUP_EN | IOPCTL_PSEDRAIN_EN;
    IOPCTL->FC15_I2C_SDA = IOPCTL_INBUF_EN | IOPCTL_PIO_PUPD_EN |
            IOPCTL_PIO_PULLUP_EN | IOPCTL_PSEDRAIN_EN;
}
/***********************************************************************************************************************
 * EOF
