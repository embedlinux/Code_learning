...
- pin_list:
  ...
  - {pin_num: A3, peripheral: SCT0, signal: 'OUT, 0', pin_signal: PIO0_14/FC2_SCK/SCT0_PIN_INP0/SCT0_OUT0/CTIMER2_MAT0/SEC_P0_14, pupdena: disabled, pupdsel: pullDown,
    ibena: disabled, slew_rate: normal, drive: normal, amena: disabled, odena: disabled, iiena: disabled}
  - {pin_num: A2, peripheral: SCT0, signal: 'OUT, 6', pin_signal: PIO0_26/FC3_SSEL2/SCT0_PIN_INP6/SCT0_OUT6/CTIMER_INP7/SEC_P0_26, pupdena: disabled, pupdsel: pullDown,
    ibena: disabled, slew_rate: normal, drive: normal, amena: disabled, odena: disabled, iiena: disabled}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    const uint32_t port0_pin14_config = (/* Pin is configured as SCT0_OUT0 */
                                         ...
                                         /* Input function is not inverted */
                                         IOPCTL_PIO_INV_DI);
    /* PORT0 PIN14 (coords: A3) is configured as SCT0_OUT0 */
