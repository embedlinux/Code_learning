...
- pin_list:
  ...
  - {pin_num: G15, peripheral: SCT0, signal: 'IN, 1', pin_signal: PIO1_1/FC4_SSEL2/SCT0_PIN_INP2/SCT0_OUT8/CTIMER1_MAT0, pupdena: disabled, pupdsel: pullDown, ibena: enabled,
    slew_rate: normal, drive: normal, amena: disabled, odena: disabled, iiena: disabled}
  - {pin_num: P16, peripheral: SCT0, signal: 'OUT, 3', pin_signal: PIO2_30/SCT0_OUT3/CLKIN, pupdena: disabled, pupdsel: pullDown, ibena: disabled, slew_rate: normal,
    drive: normal, amena: disabled, odena: disabled, iiena: enabled}
  - {pin_num: N17, peripheral: SCT0, signal: 'OUT, 0', pin_signal: PIO2_29/SCT0_OUT0/CLKOUT, pupdena: disabled, pupdsel: pullDown, ibena: disabled, slew_rate: normal,
...
{
    /* SCT0_PIN_INP2 is selected for SCT0 input 1 */
    INPUTMUX_AttachSignal(INPUTMUX, 1U, kINPUTMUX_Sct0PinInp2ToSct0);
    ...
    const uint32_t port1_pin1_config = (/* Pin is configured as SCT0_PIN_INP2 */
                                        IOPCTL_PIO_FUNC2 |
                                        /* Disable pull-up / pull-down function */
                                        IOPCTL_PIO_PUPD_DI |
                                        /* Enable pull-down function */
                                        ...
                                        /* Input function is not inverted */
                                        IOPCTL_PIO_INV_DI);
    /* PORT1 PIN1 (coords: G15) is configured as SCT0_PIN_INP2 */
    IOPCTL_PinMuxSet(IOPCTL, 1U, 1U, port1_pin1_config);

    const uint32_t port2_pin29_config = (/* Pin is configured as SCT0_OUT0 */
                                         IOPCTL_PIO_FUNC2 |
                                         /* Disable pull-up / pull-down function */
                                         IOPCTL_PIO_PUPD_DI |
                                         /* Enable pull-down function */
                                         ...
                                         /* Input function is not inverted */
                                         IOPCTL_PIO_INV_DI);
    /* PORT2 PIN29 (coords: N17) is configured as SCT0_OUT0 */
    IOPCTL_PinMuxSet(IOPCTL, 2U, 29U, port2_pin29_config);

    const uint32_t port2_pin30_config = (/* Pin is configured as SCT0_OUT3 */
                                         IOPCTL_PIO_FUNC2 |
                                         /* Disable pull-up / pull-down function */
                                         IOPCTL_PIO_PUPD_DI |
                                         /* Enable pull-down function */
                                         ...
                                         /* Pseudo Output Drain is disabled */
                                         IOPCTL_PIO_PSEDRAIN_DI |
                                         /* Input function is inverted */
                                         IOPCTL_PIO_INV_EN);
    /* PORT2 PIN30 (coords: P16) is configured as SCT0_OUT3 */
