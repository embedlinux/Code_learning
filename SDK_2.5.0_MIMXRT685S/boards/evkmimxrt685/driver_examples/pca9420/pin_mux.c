...
- pin_list:
  ...
  - {pin_num: G2, peripheral: FLEXCOMM0, signal: TXD_SCL_MISO_WS, pin_signal: PIO0_1/FC0_TXD_SCL_MISO_WS/CTIMER0_MAT1, pupdena: disabled, pupdsel: pullDown, ibena: disabled,
    slew_rate: normal, drive: normal, amena: disabled, odena: disabled, iiena: disabled}
  - {pin_num: B9, peripheral: CLKCTL1, signal: CLKOUT, pin_signal: PIO0_24/FC3_CTS_SDA_SSEL0/CTIMER3_MAT3/FC2_SSEL2/CLKOUT}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    IOPCTL->FC15_I2C_SCL = IOPCTL_FC15_I2C_SCL_PUPDENA(1) | IOPCTL_FC15_I2C_SCL_PUPDSEL(1) |
                           IOPCTL_FC15_I2C_SCL_IBENA(1) | IOPCTL_FC15_I2C_SCL_ODENA(1);
    IOPCTL->FC15_I2C_SDA = IOPCTL_FC15_I2C_SDA_PUPDENA(1) | IOPCTL_FC15_I2C_SDA_PUPDSEL(1) |
                           IOPCTL_FC15_I2C_SDA_IBENA(1) | IOPCTL_FC15_I2C_SDA_ODENA(1);
}
/***********************************************************************************************************************
 * EOF
 **********************************************************************************************************************/
