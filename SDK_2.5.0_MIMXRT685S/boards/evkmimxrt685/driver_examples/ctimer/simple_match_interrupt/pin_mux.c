...
- pin_list:
  ...
  - {pin_num: T15, peripheral: CTIMER2, signal: 'MATCH, 0', pin_signal: PIO2_10/SD0_RESET_N/SCT0_PIN_INP6/CTIMER2_MAT0, pupdena: disabled, pupdsel: pullDown, ibena: disabled,
    slew_rate: normal, drive: normal, amena: disabled, odena: disabled, iiena: disabled}
  - {pin_num: T16, peripheral: CTIMER2, signal: 'MATCH, 1', pin_signal: PIO2_11/SD0_VOLT/SCT0_PIN_INP7/CTIMER2_MAT1, pupdena: disabled, pupdsel: pullDown, ibena: disabled,
    slew_rate: normal, drive: normal, amena: disabled, odena: disabled, iiena: disabled}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    const uint32_t port0_pin15_config = (/* Pin is configured as CTIMER2_MAT1 */
                                         ...
                                         /* Input function is not inverted */
                                         IOPCTL_PIO_INV_DI);
    IOPCTL_PinMuxSet(IOPCTL, 0, 15U, port0_pin15_config);
}
/***********************************************************************************************************************
 * EOF
 **********************************************************************************************************************/
