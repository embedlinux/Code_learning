...
- pin_list:
  ...
  - {pin_num: G1, peripheral: CTIMER0, signal: 'MATCH, 0', pin_signal: PIO0_0/FC0_SCK/CTIMER0_MAT0/SEC_P0_0, pupdena: disabled, pupdsel: pullDown, ibena: disabled,
...
void BOARD_InitPins(void)
{
    ...
    const uint32_t port0_pin0_config = (/* Pin is configured as CTIMER0_MAT0 */
                                        IOPCTL_PIO_FUNC4 |
                                        ...
                                        IOPCTL_PIO_INV_DI);
    /* PORT0 PIN0 (coords: G1) is configured as CTIMER0_MAT0 */
