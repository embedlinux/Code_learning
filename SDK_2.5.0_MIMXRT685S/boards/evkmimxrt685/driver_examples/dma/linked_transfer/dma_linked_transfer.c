...
int main(void)
{
    ...
    DMA_SetupDescriptor(&(s_dma_table[0]), DMA_CHANNEL_XFER(true, false, false, true, 4U, kDMA_AddressInterleave1xWidth,
                                                            kDMA_AddressInterleave1xWidth, 16U),
                        s_srcBuffer1, &s_destBuffer[0], &(s_dma_table[1]));

    DMA_SetupDescriptor(&(s_dma_table[1]), DMA_CHANNEL_XFER(true, false, false, true, 4U, kDMA_AddressInterleave1xWidth,
                                                            kDMA_AddressInterleave1xWidth, 16U),
