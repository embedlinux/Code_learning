...
#define EXAMPLE_TARGET_CLOCK_2_NAME "Clock Out clock"
#define EXAMPLE_TARGET_CLOCK_3_NAME "FFRO clock"
#define EXAMPLE_TARGET_CLOCK_1 kINPUTMUX_XtalinToFreqmeas
#define EXAMPLE_TARGET_CLOCK_2 kINPUTMUX_ClockOutToFreqmeas
#define EXAMPLE_TARGET_CLOCK_3 kINPUTMUX_FircToFreqmeas
#define EXAMPLE_TARGET_CLOCK_1_FREQUENCY CLOCK_GetXtalInClkFreq()
#define EXAMPLE_TARGET_CLOCK_2_FREQUENCY CLOCK_GetFreq(kCLOCK_ClockOut)
