...
void BOARD_InitPins(void)
{
    ...
    const uint32_t port0_pin5_config = (/* Pin is configured as FC0_RXD_SDA_MOSI_DATA */
                                        IOPCTL_FUNC0 |
                                        /* Disable pull-up / pull-down function */
                                        IOPCTL_PIO_PUPD_DI |
                                        /* Enable pull-down function */
    ...
    IOPCTL_PinMuxSet(IOPCTL, 0U, 6U, port0_pin5_config);
//    IOPCTL_PinMuxSet(IOPCTL, 0U, 12U, port0_pin5_config);
//    IOPCTL_PinMuxSet(IOPCTL, 0U, 13U, port0_pin5_config);
}
/***********************************************************************************************************************
 * EOF
 **********************************************************************************************************************/
