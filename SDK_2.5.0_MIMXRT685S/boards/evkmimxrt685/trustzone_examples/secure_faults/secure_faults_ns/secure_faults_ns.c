...
#define DEMO_NONSEC_ADDRESS 0x000D0000
...
int main(void)
{
    ...
    /* Remove compiler warning about the variable not being used. */
    (void)test_value;

    /**************************************************************************
    * TEST EXAMPLE 3 - Invalid data access from normal world
    * In this example the pointer is set to secure address.
    ...
    * In this example the input parameter is set to secure address.
    * This address has secure attribute (see SAU settings)
    ...
    * In this example the pointer is set to non-secure address.
