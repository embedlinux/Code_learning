 ...
 * 0x200D0000 - 0x200E0000 - SRAM memory for TEST EXAMPLE 5
...
void BOARD_InitTrustZone()
{
    ...
    AHB_SECURE_CTRL->RAM12_15[0].RAM14_MEM_RULE[2] = 0x33333333U;
    AHB_SECURE_CTRL->RAM12_15[0].RAM14_MEM_RULE[3] = 0x33333333U;
