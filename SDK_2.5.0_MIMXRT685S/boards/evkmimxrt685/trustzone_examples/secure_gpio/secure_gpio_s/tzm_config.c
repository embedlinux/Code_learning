...
void BOARD_InitTrustZone()
{
    ...
    /* Configure SAU region 2 - Non-secure QSPI FLASH for CODE execution*/
    /* Set SAU region number */
    SAU->RNR = 2;
    /* Region base address */
    ...
    AHB_SECURE_CTRL->APB_BRIDGE[0].APB_GRP0_MEM_RULE0 =
        AHB_SECURE_CTRL_APB_BRIDGE_APB_GRP0_MEM_RULE0_RSTCTL0_RULE0(0x3U) |
        AHB_SECURE_CTRL_APB_BRIDGE_APB_GRP0_MEM_RULE0_CLKCTL0_RULE1(0x3U) |
        AHB_SECURE_CTRL_APB_BRIDGE_APB_GRP0_MEM_RULE0_SYSCTL0_RULE2(0x3U) |
        AHB_SECURE_CTRL_APB_BRIDGE_APB_GRP0_MEM_RULE0_IOPCTL_RULE4(0x3U);
    AHB_SECURE_CTRL->APB_BRIDGE[0].APB_GRP1_MEM_RULE0 =
        AHB_SECURE_CTRL_APB_BRIDGE_APB_GRP1_MEM_RULE0_RSTCTL1_RULE0(0x3U) |
        AHB_SECURE_CTRL_APB_BRIDGE_APB_GRP1_MEM_RULE0_CLKCTL1_RULE1(0x3U) |
    ...
    AHB_SECURE_CTRL->AHB_PERIPH3_SLAVE_RULE = AHB_SECURE_CTRL_AHB_PERIPH3_SLAVE_RULE_SECURE_GPIO_RULE3(0x3U);
    /* Enable AHB secure controller check and lock all rule registers */
    AHB_SECURE_CTRL->MISC_CTRL_DP_REG = (AHB_SECURE_CTRL->MISC_CTRL_DP_REG &
