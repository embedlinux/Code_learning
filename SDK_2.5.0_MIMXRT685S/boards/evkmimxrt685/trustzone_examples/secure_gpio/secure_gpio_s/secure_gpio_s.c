...
#define DEMO_SECURE_SW1_GPIO_PIN 27U
#define DEMO_SW1_GPIO GPIO
#define DEMO_SW1_GPIO_PORT 0U
#define DEMO_SW1_GPIO_PIN 27U
...
#define DEMO_BLUE_LED_PIN_SEC_MASK AHB_SECURE_CTRL_SEC_GPIO_MASK0_PIO0_PIN27_SEC_MASK_MASK
...
void SysTick_Handler(void)
{
    ...
    /* Control green LED based on secure button press */
...
int main(void)
{
    ...
    SysTick_Config(USEC_TO_COUNT(5000U, SystemCoreClock));
