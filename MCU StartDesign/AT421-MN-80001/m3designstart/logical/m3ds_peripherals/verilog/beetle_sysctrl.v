...
//      SVN Information
//
//      Checked In          : $Date: 2013-07-10 16:42:42 +0100 (Wed, 10 Jul 2013) $
//
...
// --------------------------------------------------------------------------
  ...
  input  wire          BIGEND,     // Endianness

  output wire          HREADYOUT,  // AHB ready output to S->M mux
  output wire          HRESP,      // AHB response
  output wire [31:0]   HRDATA,     // AHB read data bus

  output wire [31:0]   AHBPER0_REG,// Access permission for GPIOs
  output wire [31:0]   APBPER0_REG,// Access permission for APB peripherals
...
// Local parameter for IDs,
  localparam  ARM_CMSDK_CM_SYSCTRL_PID4 = {32'h00000004}; // 0xFD0 : PID 4
  localparam  ARM_CMSDK_CM_SYSCTRL_PID5 = {32'h00000000}; // 0xFD4 : PID 5
  localparam  ARM_CMSDK_CM_SYSCTRL_PID6 = {32'h00000000}; // 0xFD8 : PID 6
  localparam  ARM_CMSDK_CM_SYSCTRL_PID7 = {32'h00000000}; // 0xFDC : PID 7
  localparam  ARM_CMSDK_CM_SYSCTRL_PID0 = {32'h00000027}; // 0xFE0 : PID 0 part number[7:0]
  localparam  ARM_CMSDK_CM_SYSCTRL_PID1 = {32'h000000B8}; // 0xFE4 : PID 1 [7:4] jep106_id_3_0. [3:0] part number [11:8]
  localparam  ARM_CMSDK_CM_SYSCTRL_PID2 = {32'h0000001B}; // 0xFE8 : PID 2 [7:4] revision, [3] jedec_used. [2:0] jep106_id_6_4
  localparam  ARM_CMSDK_CM_SYSCTRL_PID3 = {32'h00000000}; // 0xFEC : PID 3
  localparam  ARM_CMSDK_CM_SYSCTRL_CID0 = {32'h0000000D}; // 0xFF0 : CID 0
  localparam  ARM_CMSDK_CM_SYSCTRL_CID1 = {32'h000000F0}; // 0xFF4 : CID 1 PrimeCell class
  localparam  ARM_CMSDK_CM_SYSCTRL_CID2 = {32'h00000005}; // 0xFF8 : CID 2
  localparam  ARM_CMSDK_CM_SYSCTRL_CID3 = {32'h000000B1}; // 0xFFC : CID 3
  ...
  1'b1:
     begin
      if (reg_addr[11:5] == 7'h00) begin
         ...
         case (reg_addr[5:2])
          4'h4:  read_mux_le =   ARM_CMSDK_CM_SYSCTRL_PID4;  //0xFD0 Peripheral ID 4
          4'h5:  read_mux_le =   ARM_CMSDK_CM_SYSCTRL_PID5;  //0xFD4 Peripheral ID 5
          4'h6:  read_mux_le =   ARM_CMSDK_CM_SYSCTRL_PID6;  //0xFD8 Peripheral ID 6
          4'h7:  read_mux_le =   ARM_CMSDK_CM_SYSCTRL_PID7;  //0xFDC Peripheral ID 7
          4'h8:  read_mux_le =   ARM_CMSDK_CM_SYSCTRL_PID0;  //0xFE0 Peripheral ID 0
          4'h9:  read_mux_le =   ARM_CMSDK_CM_SYSCTRL_PID1;  //0xFE4 Peripheral ID 1
          4'hA:  read_mux_le =   ARM_CMSDK_CM_SYSCTRL_PID2;  //0xFE8 Peripheral ID 2
          4'hB:  read_mux_le =   {ARM_CMSDK_CM_SYSCTRL_PID3[31:8], ECOREVNUM[3:0], 4'h0}; //0xFEC Peripheral ID 3
          4'hC:  read_mux_le =   ARM_CMSDK_CM_SYSCTRL_CID0;  //0xFF0 Component ID 0
          4'hD:  read_mux_le =   ARM_CMSDK_CM_SYSCTRL_CID1;  //0xFF4 Component ID 1
          4'hE:  read_mux_le =   ARM_CMSDK_CM_SYSCTRL_CID2;  //0xFF8 Component ID 2
          4'hF:  read_mux_le =   ARM_CMSDK_CM_SYSCTRL_CID3;  //0xFFC Component ID 3
  ...
  // Remap register
  // ----------------------------------------------------------
  wire      reg_remap_write = reg_write_enable &
  ...
  // PMUENABLE register
  // ----------------------------------------------------------
  wire      reg_pmuenable_write = reg_write_enable &
  ...
  // ----------------------------------------------------------
  wire      reg_lockupreset_write = reg_write_enable &
  ...
  wire      reg_resetinfo_write = reg_write_enable &
  ...
  assign AHBPER0_REG = {32{1'b0}};        // None of AHB periperals are configured to be secure

  // APBPER0[0]  - Timer0 is secure only
  // APBPER0[1]  - Timer1 is secure only
  // APBPER0[15] - TRNG is secure only
  assign APBPER0_REG = {{16{1'b0}}, 1'b1, {13{1'b0}}, 2'b11};
