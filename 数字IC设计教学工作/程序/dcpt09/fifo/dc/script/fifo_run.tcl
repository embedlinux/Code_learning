#------------------------------------------------------------------------------
# File   : A TCL format DC script file for a FIFO
# Author : xinxn 
# date   : 2009-04-02    
#------------------------------------------------------------------------------
...
set WORK_DIR /usr/dcpt09/fifo/dc
...
#------------------------------------------------------------------------------
set NETLIST_FILE $WORK_DIR/netlist/fifo16x8_gate.v
set DESIGN_DB_FILE $WORK_DIR/netlist/fifo16x8.db
set SDC_FILE  $WORK_DIR/sdc/fifo16x8.sdc
#------------------------------------------------------------------------------
set CLK_PER 2.0
...
#----------------------------------------------------------------------------------
read_verilog $WORK_DIR/code/rr16.v
read_verilog $WORK_DIR/code/fifo_rtl.v
