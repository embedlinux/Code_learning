...
set_output_delay -max 8 -clock clk_1 [get_ports clk_tx]
set_output_delay -min 1 -clock clk_1 [get_ports clk_tx]
set_dont_touch_network [get_clocks clk_1]
#set_fix_hold clk_1

compile

report_timing > /usr/xxn/dc2/rpt//setup_time_4.rpt
report_timing -delay min > /usr/xxn/dc2/rpt/hold_time_4.rpt
report_cell > /usr/xxn/dc2/rpt/cell_4.rpt
report_area > /usr/xxn/dc2/rpt/area_4.rpt
report_power > /usr/xxn/dc2/rpt/power_4.rpt



write -format verilog -hier -o /usr/xxn/dc2/netlist/div.gv
