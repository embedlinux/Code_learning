...
set_output_delay -max 4 -clock clk [get_ports cy]
...
report_timing > /usr/xxn/dc2/rpt//setup_time_3.rpt
report_timing -delay min > /usr/xxn/dc2/rpt/hold_time_3.rpt
report_cell > /usr/xxn/dc2/rpt/cell_3.rpt
report_area > /usr/xxn/dc2/rpt/area_3.rpt
report_power > /usr/xxn/dc2/rpt/power_3.rpt



write -format verilog -hier -o /usr/xxn/dc2/netlist/counter3.gv
