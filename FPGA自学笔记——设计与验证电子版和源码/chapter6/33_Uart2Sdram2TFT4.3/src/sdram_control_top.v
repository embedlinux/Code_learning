...
//	assign sd_caddr = (!Rst_n)?9'd0:(sd_wr_req?wr_sdram_addr[8:0]:
//							(sd_rd_req?rd_sdram_addr[8:0]:sd_caddr));
...
//	assign sd_raddr = (!Rst_n)?13'd0:(sd_wr_req?wr_sdram_addr[21:9]:
//							(sd_rd_req?rd_sdram_addr[21:9]:sd_raddr));
...
//	assign sd_baddr = (!Rst_n)?2'd0:(sd_wr_req?wr_sdram_addr[23:22]:
//							(sd_rd_req?rd_sdram_addr[23:22]:sd_baddr));
