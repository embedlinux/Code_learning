...
function bit[7:0] sub1;
input [7:0] a;
input [7:0] b;
input [7:0] cin; 
sub1 = sub_min (a, b) + cin;
endfunction

function bit[7:0] sub_min;
input [7:0] a;
input [7:0] b;
sub_min = a - b;
endfunction

function bit[7:0] a_op;
input [7:0] a;
input [7:0] b;
a_op = a & b;
endfunction

function bit[7:0] or_op ;
input [7:0] a;
input [7:0] b;
or_op = a | b;
endfunction
...
always_comb
   begin
	 ...
	 `SUB1:    {carry,out} = sub1(op.a,op.b,op.cin);
	 `AND_OP:  {carry,out} = a_op(op.a,op.b);
	 `OR_OP:   {carry,out} = or_op(op.a,op.b);
