...
module tb_assert_simulation  ;
   ...
   initial
      begin
         ...
         //
         aoe_1_sampling_event=1'b1; aoe_1_test_expr=1'b1;
         aoe_2_sampling_event=1'b0; aoe_2_test_expr=1'b1;
         aoe_3_sampling_event=1'b1; aoe_3_test_expr=1'b1;
         aoe_4_sampling_event=1'b0; aoe_4_test_expr=1'b1;
         //
         ...
         // =====
         // 4 instances but only 2-then-3 failures (due to `OVL_IGNORE & `OVL_ASSERT_2STATE)
         #100 sim_info ("always X-check", "2 X-fail: ERROR (1 ASSUME, 1 ASSERT)");
         alw_1_test_expr=1'bX; alw_2_test_expr=1'bX; alw_3_test_expr=1'bX; alw_4_test_expr=1'bX;
         #100 sim_info ("always 2val-check", "3 Fail: ERROR (1 ASSUME, 2 ASSERT)");
         alw_1_test_expr=1'b0; alw_2_test_expr=1'b0; alw_3_test_expr=1'b0; alw_4_test_expr=1'b0;
         #100
         ...
         // INDEX:        - assert_even_parity
         // =====
         #100 sim_info ("even_parity X-check", "1 X-fail: ERROR");
         evp_1_test_expr=8'b0000_0X00;
...
//           $display("# OVL_METRICS : %d OVL firings reported during completed simulation", `OVL_COUNTER);
   ...
   initial
     begin
        #99800 sim_info ("never 2val-check", "1 fail: FATAL");
   ...
   initial begin
//     $dumpfile("dump2.vpd");
 //     $dumpvars(0,tb_assert_simulation);
$vcdpluson(0,tb_assert_simulation);
