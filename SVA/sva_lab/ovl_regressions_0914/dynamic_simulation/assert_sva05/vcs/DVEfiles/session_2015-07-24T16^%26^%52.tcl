...
# DVE full session
# Saved on Fri Jul 24 16:26:52 2015
# Designs open: 1
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{797 251} {1580 826}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 372} {height 324} {dock_state left} {dock_on_new_line true} {child_hier_colhier 247} {child_hier_coltype 116} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_set_window_pref_key -window ${DLPane.1} -key dock_height -value_type integer -value 371
gui_set_window_pref_key -window ${DLPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 297} {height 324} {dock_state left} {dock_on_new_line true} {child_data_colvariable 190} {child_data_colvalue 29} {child_data_coltype 67} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
set Console.1 [gui_create_window -type Console -parent ${TopLevel.1} -dock_state bottom -dock_on_new_line true -dock_extent 105]
gui_set_window_pref_key -window ${Console.1} -key dock_width -value_type integer -value 784
gui_set_window_pref_key -window ${Console.1} -key dock_height -value_type integer -value 105
gui_set_window_pref_key -window ${Console.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 783} {height 105} {dock_state bottom} {dock_on_new_line true}}
...
gui_sg_addsignal -group "$_session_group_3" { tb_assert_simulation.DUT.u_wuc_1.clk tb_assert_simulation.DUT.u_wuc_1.reset_n tb_assert_simulation.DUT.u_wuc_1.start_event tb_assert_simulation.DUT.u_wuc_1.test_expr tb_assert_simulation.DUT.u_wuc_1.end_event tb_assert_simulation.DUT.u_wuc_1.error_count tb_assert_simulation.DUT.u_wuc_1.cover_count tb_assert_simulation.DUT.u_wuc_1.window }
...
catch {gui_list_expand -id ${Hier.1} tb_assert_simulation.DUT.u_nxt_1}
catch {gui_list_select -id ${Hier.1} {{tb_assert_simulation.DUT.u_nxt_1.\_$$txp_fail_action_ovl_assert.a_assert_next_start_without_test.A_ASSERT_NEXT_XZ_ON_TEST_EXPR_P }}}
...
gui_list_show_data -id ${Data.1} {tb_assert_simulation.DUT.u_nxt_1.\_$$txp_fail_action_ovl_assert.a_assert_next_start_without_test.A_ASSERT_NEXT_XZ_ON_TEST_EXPR_P }
...
gui_wv_zoom_timerange -id ${Wave.1} 14832 15146
...
gui_list_set_insertion_bar  -id ${Wave.1} -group Group1  -item tb_assert_simulation.DUT.u_wuc_1.window -position below
