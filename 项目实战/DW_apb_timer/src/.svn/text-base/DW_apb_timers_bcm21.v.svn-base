...
////////////////////////////////////////////////////////////////////////////////
//
//                  (C) COPYRIGHT 2005 - 2010 SYNOPSYS, INC.
//                            ALL RIGHTS RESERVED
//
...
//
// Filename    : DW_apb_timers_bcm21.v
// Author      : Doug Lee    2/20/05
// Description : DW_apb_timers_bcm21.v Verilog module for DWbb
//
...
// Leda complains about the sample_nsyncf register below not being properly synchronized
// This is a false error because it is in fact the first register in the synchronization
// path; the variable is defined as data_s which is the input; afterwards it goes into
// register next_sample_syncm1 above which implements the second synchronization register;
// although there is a mux in the path, it is controlled by a parameter so it actually does
// not add any logic between the two registers
// leda NTL_CLK05 off 
