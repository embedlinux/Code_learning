...
#define     __REGCHAR(x)				(*(volatile unsigned char *)(x)) 
...
#define     NFCMD                    __REGCHAR(0x4E000008)  //NAND flash command                   
#define     NFADDR                   __REGCHAR(0x4E00000C)  //NAND flash address                   
#define     NFDATA                   __REGCHAR(0x4E000010)  //NAND flash data                      
...
#define     NFSTAT                   __REGCHAR(0x4E000020)  //NAND flash operation status          
...
#define     UTXH0                    __REGCHAR(0x50000020)  //UART 0 transmission hold 
#define     URXH0                    __REGCHAR(0x50000024)  //UART 0 receive buffer    
