...
assign EmptyFIFO = EmptyFIFOReg;
assign FullFIFO  = FullFIFOReg;
assign ReadCmd   = ReadCmdReg;
assign WriteCmd  = WriteCmdReg;
//
// --------------------------------------------------------
