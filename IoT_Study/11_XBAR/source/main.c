...
//	GPT1_Init(3750-1,10000);						//设置GPT1 0.5秒钟产生一次中断
	...
	//QTMR_PWM_Init(30,14,5000,0);
	//QTMR_PWM_Init(33,14,5000,0);
	XBAR1_Init(40,13);											//将TIMER4_0映射到GPIO_AD_B0_03(gpio1_3)
	while(1)
	{
		...
		if(led1pwmval==0)
			dir=1;
		QTMR_PWM_DutySet(40,14,5000,led1pwmval);
		//QTMR_PWM_DutySet(33,14,5000,led1pwmval);
