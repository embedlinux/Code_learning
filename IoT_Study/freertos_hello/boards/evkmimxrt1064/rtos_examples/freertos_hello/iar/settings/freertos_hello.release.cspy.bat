...
"F:\Program Filesx86\IAR\common\bin\cspybat" -f "D:\code\c_language\data-struct\IoT_Study\freertos_hello\boards\evkmimxrt1064\rtos_examples\freertos_hello\iar\settings\freertos_hello.release.general.xcl" "--debug_file=%~1" --backend -f "D:\code\c_language\data-struct\IoT_Study\freertos_hello\boards\evkmimxrt1064\rtos_examples\freertos_hello\iar\settings\freertos_hello.release.driver.xcl" 
